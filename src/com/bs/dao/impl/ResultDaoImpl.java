...
public class ResultDaoImpl extends HibernateDaoSupport implements ResultDao{
	...
	{
		String hql="select t1.tname,t2.tname,p1.pname,p2.pname,c.date,p.pname,c.place,r.t1_appraisalJudge,r.t2_appraisalJudge "
	...
	{
		String hql="select r.cid,c.date,c.place,p.pname,t.tname "
